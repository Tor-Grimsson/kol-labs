...
/**
 * EditorIcon shim — the editor package's private icon registry isn't vendored
 * into kol-para-type. The names TabsRow asks for (`close`, `chevron-down`)
 * exist in the kol-loader registry, so we resolve via our project's Icon.
 */
const EditorIcon = ({ name, size = 14, ...rest }) => <Icon name={name} size={size} {...rest} />
