...
export default function MoirePage() {
  ...
  useEffect(() => {
    ...
    const render = () => renderMoire(cv, resolveDeep(params, timeRef.current), timeRef.current)
  ...
  }, [grids, combine, hardness, palette, invert, playing, tempo, aspect, audioActive]) // eslint-disable-line react-hooks/exhaustive-deps
